                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="id_produk">
                                                        ...
                                                        <option value="{{ $category->id_produk }}">{{ $category->nama_produk }} ~~ Rp.{{ $category->harga_produk }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="form-group">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="/transaksi/transaksis/{transaksi}" class="badge bg-info"><i class="fas fa-eye d-inline"></i></span></a></td>
