...
<body>
            ...
            <nav class="uk-navbar-container uk-navbar-transparent" uk-navbar>
                <div class="uk-navbar-left">
                    <ul class="uk-navbar-nav">
                        ...
                        <li class="uk-active" uk-scroll><a href="/#about" uk-scroll>Active</a></li>
                        <li><a href="#">Item</a></li>
    ...
    <div class="uk-section uk-section-primary" id="abouts">
    ...
    <nav class="uk-navbar-container" id="about" uk-navbar>
        <div class="uk-navbar-center">
