            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="/produk" class="nav-link <?php echo e(($title === 'Data Produk')? 'active' : ''); ?>">
                        ...
                        <li class="nav-item">
                            <a href="/data_admin" class="nav-link <?php echo e(($title === 'Data Admin')? 'active' : ''); ?>">
                                <i class="nav-icon fas fa-th"></i>
                                <p>
                                    Admin
                                </p>
        ...
        </aside><?php /**PATH E:\Laravel\dondon-beach\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>