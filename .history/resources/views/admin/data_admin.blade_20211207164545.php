                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <form action="/data_admin/data/{{$user->id}}/" method="post" class="d-inline">
                                            @method ('delete')
                                            @csrf
                                            <button class="badge badge-danger border-0" onclick="return confirm('Ingin menghapus data?')"><i class="fas fa-eye-alt"></i></button>
                                        </form>
                                    </td>
                                </tr>
                                @endforeach
