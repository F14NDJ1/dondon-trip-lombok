                                                    ...
                                                    <div class="carousel-item active">
                                                        <div class="row h-100">
                                                            ...
                                                            <div class="col-md-4 mb-3 ">
                                                                <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="<?php echo e($p->gambar); ?>" alt="" />
                                                                    <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                                                                        <div class="pt-3"><span class="badge bg-primary">Rp. <?php echo e($p->harga_produk); ?></span></div>
                                                                        <div class="ps-3 d-flex justify-content-between align-items-center">
                                                                            <h5 class="text-white"><?php echo e($p->nama_produk); ?></h5>
...
</html><?php /**PATH E:\Laravel\dondon-beach\resources\views/welcome.blade.php ENDPATH**/ ?>