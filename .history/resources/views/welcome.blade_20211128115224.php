...
<body>
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Jasa Trip </h5>
    ...
    <script>
        window.jQuery || document.write('<script src="gallery_assets/js/vendor/jquery-1.11.2.min.js"><\/script>')
    </script>

    <script src="gallery_assets/js/vendor/bootstrap.min.js"></script>

    <script src="gallery_assets/js/plugins.js"></script>
