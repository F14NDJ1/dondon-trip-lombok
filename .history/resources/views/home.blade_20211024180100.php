...
<body>
    <div class="uk-position-relative">
        <div class="uk-height-large uk-background-cover uk-light uk-flex uk-flex-top" uk-parallax="bgy: -200" style="background-image: url('img/gambar1.jpg');">
            ...
            <h1 class="uk-width-1-2@m uk-text-center uk-margin-auto uk-margin-auto-vertical" uk-parallax="y: 100,0">Hai! Welcome <button class="uk-button uk-button-default uk-button-small">Whats'up</button></h1>
        ...
        <div class="uk-position-top">
            <nav class="uk-navbar-container uk-navbar-transparent" uk-navbar>
                ...
                <div class="uk-navbar-right">
                    <ul class="uk-navbar-nav">
                        <li>
                            <button class="uk-button uk-button-default" type="button" uk-toggle="target: #offcanvas-flip"><span class="uk-margin-small-right" uk-icon="user"></span></button>
