                ...
                <div class="row align-items-center min-vh-75 my-lg-8">
                    <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
                        ...
                        <p class="mt-4 mb-5 fs-1 lh-base">JANGAN KE LOMBOK NANTI GAK MAU PULANG!
                            Liburan di Lombok kurang lengkap kalau belum cobain berbagai trip di pantai Dondon. Tunggu Apa lagi
                            pesan sekarang juga!<br class="d-none d-lg-block" />Berbagai Trip menarik dan Jasa kami sediakan disini. <br class="d-none d-lg-block" />Pesan Sekarang</p><a class="btn btn-lg btn-success hover-top" href="#" role="button">WhatsApp Me</a>
                    </div>
                </div>
            </div>
        </section>
