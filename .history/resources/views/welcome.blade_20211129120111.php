                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="row h-100">
                                        ...
                                        <!-- @foreach($produk as $p) -->
                                        <div class="col-md-4 mb-3">
                                            <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="/img/1.jpg" alt="" />
                                                <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                                                    <div class="pt-3"><span class="badge bg-primary"></span></div>
                                                    <div class="ps-3 d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="/img/2.jpg" alt="" />
                                                <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                                                    <div class="pt-3"><span class="badge bg-primary"></span></div>
                                                    <div class="ps-3 d-flex justify-content-between align-items-center">
                                                        <h5 class="text-white"></h5>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="/img/3.jpg" alt="" />
                                                <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                                                    <div class="pt-3"><span class="badge bg-primary"></span></div>
                                                    <div class="ps-3 d-flex justify-content-between align-items-center">
                                                        <h5 class="text-white"></h5>
