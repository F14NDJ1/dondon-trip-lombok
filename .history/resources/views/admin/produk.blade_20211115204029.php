                                        ...
                                        <form method="POST" action="admin/prdouk/input">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control @error('kategori') is-invalid @enderror" aria-label=" Default select example" name="kategori">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control @error('deskripsi') is-invalid @enderror" rows=" 3" placeholder="Enter ..."></textarea>
                                                </div>
                                            </div>
                                            <!-- /.card-body -->
