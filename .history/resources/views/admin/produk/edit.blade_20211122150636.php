        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form method="POST" action="/produk/produks/{{ $produk->id_produk}}" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    @if($produk->gambar)
                                    <img src="{{ asset('storage/' . $produk->gambar) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                                    @else
