...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="#">
                        Welcome, <?php echo e(auth()->user()->username); ?> <i class="fas fa-sign-out-alt"></i>
                    </a>
        ...
        <!-- JavaScript Bundle with Popper --><?php /**PATH E:\Laravel\dondon-beach\resources\views/admin/partials/header.blade.php ENDPATH**/ ?>