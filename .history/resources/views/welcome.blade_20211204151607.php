...
<body>
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg fixed-top py-3 backdrop" data-navbar-on-scroll="data-navbar-on-scroll">
            <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="#"> <img class="d-inline-block align-top img-fluid img-thumbnail rounded-circle" src="img/dondon-word.png" alt="" width="50" /><span class="text-primary fs-4 ps-2" style="font-size:10vw;">Dondon Trip Lombok</span></a>
                ...
                <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link text-600" href="#featuresVideos">Gallery</a></li>
            ...
            <div class="container">
                <div class="row flex-md-center">
                    <div class="col-md-11 col-lg-4 py-md-3 px-4 px-md-3 px-lg-0 px-xl-2 order-lg-1">
                        <h1 class="fw-bold fs-md-3 fs-xl-5">Berbagai paket trip dan water sport di pantai dondon.</h1>
                            ...
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <img src="/img/dondon-word.png" width="50px" alt="">
                                        <h5 class="modal-title" id="exampleModalLabel"><b>Trip dan Jasa Dondon Trip Lombok </b></h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="order-lg-0 order-1 px-4 px-md-3 py-8 py-md-6">
                                                                ...
                                                                <div class="card h-100 text-white hover-top"><img class="img-fluid h-100" src="{{ $p->gambar }}" alt="" />
                                                                    <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                                                                        ...
                                                                        <div class="ps-3 d-flex justify-content-between align-items-center">
                                                                            ...
                                                                            <!-- <div class="pt-3 d-flex"><span class="badge bg-primary">buttDetail</span></div> -->
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                        <img src="img/2.jpeg" class="w-100 shadow-1-strong rounded mb-4" alt="" />

                        <img src="img/1.jpeg" class="w-100 shadow-1-strong rounded mb-4" alt="" />
                    </div>

                    <div class="col-lg-4 mb-4 mb-lg-0">
                        <img src="img/3.jpeg" class="w-100 shadow-1-strong rounded mb-4" alt="" />

                        <img src="img/4.jpeg" class="w-100 shadow-1-strong rounded mb-4" alt="" />
                    </div>

                    <div class="col-lg-4 mb-4 mb-lg-0">
                        <img src="img/5.jpeg" class="w-100 shadow-1-strong rounded mb-4" alt="" />

                        <img src="img/6.jpeg" class="w-100 shadow-1-strong rounded mb-4" alt="" />
                    </div>
                </div>
                <!-- Gallery -->
            </div>
        ...
        <section class="pt-5">
            <div class="container">
                <div class="row flex-center mb-5">
                    <div class="col-lg-8 text-center">
                        <h1 class="fw-bold fs-md-3 fs-lg-4 fs-xl-5">About Us</h1>
                        <hr class="mx-auto text-primary my-4" style="height:3px; width:70px;" />
                    </div>
                                    ...
                                    <div class="col-12 col-lg-7 mb-3 mb-md-0">
                                        <div class="card h-100">
                                            <div class="card-body d-flex flex-center flex-column">
                                                <p class="text-center card-text mb-5">“Dondon trip Lombok berdiri tahun 2012 yang awalnya bernama Dondon Surf dan berubah nama tahun 2021. Pengelola Dondon trip Lombok adalah para pemuda lokal, baik dari Pokdarwis maupun pegiat wisata setempat. Dengan menggunakan jasa kami anda telah ikut memberdayakan masyarakat lokal kami!.” </p>
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="d-flex align-items-center"><img width="300px" class="d-inline-block align-top img-fluid img-thumbnail rounded-circle" src="img/owner.jpeg" alt="" /></div>
                                                </div>
                                                <div class="mt-3 text-center">
                                                    <h4 class="text-1000 fw-bold">Surya Laga</h4>
                                                    <p class="fs--1 fw-normal mb-0">CEO Dondon Trip Lombok</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-12 py-8 text-white">
                        <div class="d-flex flex-column flex-center">
                            <h2 class="text-white fs-2 fs-md-3">KAMI TUNGGU ANDA</h2>
                            <h1 class="text-white fs-2 fs-sm-4 fs-lg-7 fw-bold">DI DONDON</h1>
                            <!-- <iframe width="600" height="450" style="border:0" loading="lazy" allowfullscreen src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJEX78pL8BzS0RBCwxuuK9fX0&key=AIzaSyBurKkDRkdKBSPFLqbJGGL6UgnjTX6Pzug"></iframe> -->
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row flex-center">
                    <div class="col-auto">
                        <ul class="list-unstyled list-inline">
                            <li class="list-inline-item me-3"><a class="text-decoration-none" href="https://www.facebook.com/Dondon-Trip-Lombok-101993665654738">
                                    ...
                                    </svg> Dondon Trip Lombok</a></li>
                            <li class="list-inline-item me-3"><a href="https://www.instagram.com/dondontriplombok/">
